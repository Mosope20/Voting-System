#include<iostream>
#include<ctime>
//to import the time library for the random number generartor
#include<cstdlib>
...
bool tieFinder(int[],int);//this finds if there are any ties within the loop if any number reoccurs
